...
if __name__ == '__main__':
    ...
    os.system("xlearn_train train-%s.libfm -s 1 -m ./xlearn.model -k 4 -e 100" % (dataset) )
    os.system("xlearn_predict test-%s.libfm xlearn.model -o test/res/libfm/%d/libfm " % (dataset, run_index) )
