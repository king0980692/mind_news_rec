...
def generate_libfm_data():
                ...
                # else:
                    ...
                    # for i in range(positive_samples_num):
                        ...
                        # for j in range(negative_sample_num):
                            ...
                            # k += 1
    # with open('exp/dev-%s.libfm' % dataset, 'w', encoding='utf-8') as dev_f:
    ...
    with open('exp/test-%s.libfm' % dataset, 'w', encoding='utf-8') as test_f:
